class Strings {
  ...
  static const applicationName = 'Weather App';

  //Home page
  static const homePageTitle = 'Current weather';
  //city queries
  ...
  static const errorServer = 'Server Failure';
  static const errorConnection = 'Check your connection!';
}